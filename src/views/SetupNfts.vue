<template>
    <div class="px-4 py-9 max-w-md m-auto">
        ...
        >
            ...
            <template #content>
                <draggable class="min-h-20" :list="show" group="nfts" itemKey="chain">
                    <template #item="{ element }">
                        <NFTItem class="shadow-nft-sm inline-flex m-0.5" :size="64" :chain="element.chain" />
                    </template>
                </draggable>
            </template>
        ...
        >
            ...
            <template #content>
                <draggable class="min-h-20" :list="hide" group="nfts" itemKey="chain">
                    <template #item="{ element }">
                        <NFTItem class="shadow-nft-sm inline-flex m-0.5" :size="64" :chain="element.chain" />
                    </template>
                </draggable>
            ...
            <template #footer-button v-if="show.length !== 0">
                <Button size="sm" class="text-xs bg-white text-nft-button shadow-nft-sm"> Show All </Button>
            </template>
        </Card>
