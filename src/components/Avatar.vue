...
@layer components {
    .avatar {
        @apply flex justify-center items-center cursor-pointer rounded overflow-hidden relative;
        ...
        .image {
            @apply object-contain object-center absolute left-0 top-0 w-full h-full;
        }
    }
}
</style>
