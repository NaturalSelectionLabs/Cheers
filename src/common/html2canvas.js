    ...
    return /******/ (function (modules) {
        ...
        /******/ [
                ...
                var NodeContainer = (function () {
                    function NodeContainer(node, parent, resourceLoader, index) {
                        ...
                        this.style = {
                            ...
                            borderRadius:
                                (node instanceof defaultView.HTMLInputElement || node instanceof HTMLInputElement) &&
                                IS_INPUT
                            ...
                            listStyle:
                                display === _display.DISPLAY.LIST_ITEM ? (0, _listStyle.parseListStyle)(style) : null,
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var polyUint32Array = (exports.polyUint32Array = function polyUint32Array(buffer) {
                    ...
                    for (var _i2 = 0; _i2 < length; _i2 += 4) {
                        bytes.push(
                            (buffer[_i2 + 3] << 24) | (buffer[_i2 + 2] << 16) | (buffer[_i2 + 1] << 8) | buffer[_i2],
                        );
                    }
                    return bytes;
                });
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var HEBREW = {
                    integers: [
                        10000, 9000, 8000, 7000, 6000, 5000, 4000, 3000, 2000, 1000, 400, 300, 200, 100, 90, 80, 70, 60,
                ...
                var GEORGIAN = {
                    integers: [
                        10000, 9000, 8000, 7000, 6000, 5000, 4000, 3000, 2000, 1000, 900, 800, 700, 600, 500, 400, 300,
                ...
                var createCJKCounter = function createCJKCounter(
                    ...
                    for (var digit = 0; tmp > 0 && digit <= 4; digit++) {
                        ...
                        if (coefficient === 0 && (0, _Util.contains)(flags, CJK_ZEROS) && string !== '') {
                            ...
                            (coefficient === 1 && digit === 1 && (0, _Util.contains)(flags, CJK_TEN_COEFFICIENTS)) ||
                            (coefficient === 1 &&
                                digit === 1 &&
                                (0, _Util.contains)(flags, CJK_TEN_HIGH_COEFFICIENTS) &&
                                value > 100) ||
                            (coefficient === 1 && digit > 1 && (0, _Util.contains)(flags, CJK_HUNDRED_COEFFICIENTS))
                        ) {
